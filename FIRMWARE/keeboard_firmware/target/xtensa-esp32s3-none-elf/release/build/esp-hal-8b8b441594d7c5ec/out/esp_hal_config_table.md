...
| <p>**ESP_HAL_CONFIG_DATA_CACHE_SIZE**</p> <p>Data cache size to be set on application startup.</p> | ⚠️ Unstable | 64KB | One of:<br/><ul style="display: inline-block; text-align: left"><li>32KB</li><li>64KB</li></ul>
